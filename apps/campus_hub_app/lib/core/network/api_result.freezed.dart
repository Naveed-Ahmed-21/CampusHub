...
mixin _$ApiResult<T> {
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(ApiResultFailure<T> value) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? mapOrNull<TResult extends Object?>({
    TResult? Function(ApiResultSuccess<T> value)? success,
    TResult? Function(ApiResultFailure<T> value)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$ApiResultFailureImpl<T> implements ApiResultFailure<T> {
  const _$ApiResultFailureImpl(this.error);
...
abstract class ApiResultFailure<T> implements ApiResult<T> {
  const factory ApiResultFailure(final ApiException error) =
      _$ApiResultFailureImpl<T>;
